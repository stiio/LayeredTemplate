...
namespace Hipaa.Backend.Plugins.Workflow.Storage.EFCore.Migrations
{
    ...
    [Migration("20260430093902_WorkflowDefinitionDisplayName")]
    partial class WorkflowDefinitionDisplayName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hipaa.Backend.Plugins.Workflow.Storage.EFCore.Entities.WorkflowStepExecution", b =>
                {
                    ...
                    b.HasIndex(new[] { "IsLongRunning", "NextAttemptAt" }, "ix_workflow_step_executions_pending_lane_next_attempt")
                        .HasFilter("status = 'pending'");

                    b.HasIndex(new[] { "IsLongRunning", "NextAttemptAt" }, "ix_workflow_step_executions_waiting_lane_next_attempt")
            ...
            modelBuilder.Entity("Hipaa.Backend.Plugins.Workflow.Storage.EFCore.Entities.WorkflowRun", b =>
                {
                    b.HasOne("Hipaa.Backend.Plugins.Workflow.Storage.EFCore.Entities.WorkflowDefinition", null)
                        .WithMany()
