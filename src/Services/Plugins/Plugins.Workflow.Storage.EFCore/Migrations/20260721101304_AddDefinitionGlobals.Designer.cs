...
namespace LayeredTemplate.Plugins.Workflow.Storage.EFCore.Migrations
{
    ...
    [Migration("20260721101304_AddDefinitionGlobals")]
    partial class AddDefinitionGlobals
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LayeredTemplate.Plugins.Workflow.Storage.EFCore.Entities.WorkflowStepExecution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "UpdatedAt" }, "ix_workflow_step_executions_running_updated_at")
            ...
            modelBuilder.Entity("LayeredTemplate.Plugins.Workflow.Storage.EFCore.Entities.WorkflowRun", b =>
                {
                    b.HasOne("LayeredTemplate.Plugins.Workflow.Storage.EFCore.Entities.WorkflowDefinition", null)
                        .WithMany()
                    ...
                    b.HasOne("LayeredTemplate.Plugins.Workflow.Storage.EFCore.Entities.WorkflowRun", null)
                        .WithMany()
                        .HasForeignKey("ParentRunId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_workflow_runs_workflow_runs_parent_run_id");

                    b.HasOne("LayeredTemplate.Plugins.Workflow.Storage.EFCore.Entities.WorkflowStepExecution", null)
                        .WithMany()
