...
namespace Hipaa.Backend.Plugins.Workflow.Storage.EFCore.Migrations
{
    ...
    [Migration("20260429201958_WorkflowLongRunningLane")]
    partial class WorkflowLongRunningLane
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hipaa.Backend.Plugins.Workflow.Storage.EFCore.Entities.WorkflowStepExecution", b =>
                {
                    ...
                    b.Property<bool>("IsLongRunning")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_long_running");
                    ...
                    b.Property<byte[]>("ResolvedConfig")
                        .IsRequired()
                        .HasColumnType("bytea")
                    ...
                    b.HasIndex("Status", "IsLongRunning", "NextAttemptAt")
                        .HasDatabaseName("ix_workflow_step_executions_status_lane_next_attempt_at");
